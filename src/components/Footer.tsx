    ...
    <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
      <div className="container-inner">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Algoverse</h3>
            <ul className="space-y-2">
              ...
              <li>
                <a href="tel:+16304007637" className="hover:text-white transition-colors">
                  +1 (630) 400-7637
                </a>
              </li>
              <li>
                <a href="mailto:admissions@algoverse.us" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#consultation" className="hover:text-white transition-colors">Schedule a consultation</a>
              </li>
            </ul>
          </div>
            ...
            <form className="space-y-3">
              <div>
                ...
                <input 
                  type="email" 
                  id="email" 
                  className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white text-sm focus:outline-none focus:ring-2 focus:ring-algoverse-500"
                  required 
                />
              </div>
              ...
              <button 
                type="submit" 
                className="w-full py-2 bg-algoverse-600 hover:bg-algoverse-700 text-white rounded-md transition-colors"
              >
                Sign Up
              </button>
            </form>
